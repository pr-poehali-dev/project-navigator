...
const faqs = [
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Rewind -- для смелых экспериментов: пробуйте новые AI-промпты, не боясь ошибиться.
        <br />
        <br />
        Это уверенность, что любую попытку можно отменить.
      </>
    ),
  },
  {
    ...
    <section className="py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-12 md:mt-16 text-center">
          ...
          >
            Начните экспериментировать смелее -- почувствуйте свободу пробовать без страха.
          </p>
